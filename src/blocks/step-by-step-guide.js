...
// Debug logging
console.log('Step-by-step guide block script loaded');
console.log('wp.blocks available:', typeof wp.blocks !== 'undefined');
console.log('registerBlockType available:', typeof wp.blocks?.registerBlockType !== 'undefined');
...
console.log('About to register block: wp-integrations-directory/step-by-step-guide');
